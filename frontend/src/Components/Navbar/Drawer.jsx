...
export default function TemporaryDrawer() {
  ...
  const { theme, setTheme,userID,setUserID, ActivateToast, setIsMemberLogin } = React.useContext(Context)
  ...
  const list = (anchor) => (
    ...
    >
      <List>
        ...
        {!userID &&  <NavLink to={"/client/login"} style={{ textDecoration: "none", color: "unset" }}><ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <Login />
            </ListItemIcon>
        ...
        <Divider />
       {userID &&  <ListItem disablePadding onClick={()=>{
              setUserID("")
              navigate("/")

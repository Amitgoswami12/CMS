...
export default function MeetingModal({
    ...
    const { apiLink, axios, ActivateToast,meetingsData,setMeetingsData } = useContext(Context);
    ...
    return (
        ...
        >
            <Box sx={style}>
                ...
                <Typography className={styles.title} variant="h5">Meeting with {data.contactName}</Typography>
                <br />
                <Box
                    display={"flex"}
                    alignItems={"center"}
                ...
                >
                    ...
                    >
                        ...
                        <DeleteFromID
                            ...
                            name={data.name}
                            id={data._id}
                            //array should be set to the original array consisting of all data
                            array={meetingsData}
                            //this should be set to original array to delete immediately, it was perviously set to temp which is an object
                            setArray={setMeetingsData}
                            //route was previously set to contacts, thats why
                            route={"meetings"}
